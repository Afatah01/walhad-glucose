...
#bigCard{background:#16213e;border-radius:22px;padding:26px 16px;text-align:center;box-shadow:0 4px 16px rgba(22,33,62,.28);margin-bottom:14px}
#num{font-size:125px;font-weight:800;line-height:1;color:#2ecc71}
#num.r{color:#e74c3c}
#num.none{color:#5a6b8c}
#unit{color:#9fb3d1;font-size:16px;font-weight:600;margin-top:2px}
#trend{font-size:34px;margin-top:6px;color:#fff}
#trendLbl{color:#9fb3d1;font-size:14px}
.card{background:#16213e;border-radius:16px;padding:16px 18px;margin-bottom:12px;box-shadow:0 3px 12px rgba(22,33,62,.22);display:flex;align-items:center;gap:14px}
.card .ic{font-size:26px}
.card .t{flex:1}
.lbl{color:#9fb3d1;font-size:13px;font-weight:600;text-transform:uppercase;letter-spacing:.5px}
.val{font-size:21px;font-weight:700;margin-top:3px;color:#fff}
.val.g{color:#2ecc71}.val.r{color:#e74c3c}
.btn{background:#2a9d8f;color:#fff;border:0;border-radius:12px;padding:11px 16px;font-weight:700;font-size:14px;cursor:pointer;white-space:nowrap}
.btn:active{opacity:.8}
a.map{color:#4dd0c4;font-weight:700;text-decoration:none}
#thresh{text-align:center;color:#8a97a8;font-size:13px;margin:6px 0 14px}
...
<div class=card><div class=ic>&#128267;</div><div class=t><div class=lbl>Phone-Bridge Battery</div><div class=val id=bat>--</div></div></div>
...
async function tick(){
 try{
  ...
  if(d.glucose==null){n.textContent='--';n.className='none';}
  else{
